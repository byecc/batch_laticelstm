...
class BiLSTM(nn.Module):
    def __init__(self, data):
        ...
        #                                 self.gpu)
        self.forward_lstm = BatchLatticeLSTM(lstm_input, lstm_hidden, data.gaz_alphabet.size(), data.gaz_emb_dim,
                                             data.pretrain_gaz_embedding, data.HP_fix_gaz_emb, True)
        if self.bilstm_flag:
            ...
            #                                  self.gpu)
            self.backward_lstm = BatchLatticeLSTM(lstm_input, lstm_hidden, data.gaz_alphabet.size(), data.gaz_emb_dim,
                                                  data.pretrain_gaz_embedding,data.HP_fix_gaz_emb,False)
